...
fn update_cursor(x: usize, y: usize) {
    ...
    unsafe {
        port::outb(VGA_PORT_COMMAND, 0x0E);  // High byte
        port::outb(VGA_PORT_DATA, (pos >> 8) as u8);

        port::outb(VGA_PORT_COMMAND, 0x0F);  // Low byte
...
pub fn putchar(c: u8) {
    _putchar_core(c, color::DEFAULT_COLOR);
}
...
pub fn putstr(s: *const u8) {
    _putstr_core(s, color::DEFAULT_COLOR);
}
...
pub fn print_welcome() {
    let c = color::get_color_code(color::Color::LightGray, color::Color::Black);

    putstr_colored(b"_/_/_/_/_/                      _/_/      _/_/_/      _/\n\0".as_ptr(), c);
    putstr_colored(b"   _/      _/_/_/    _/_/_/  _/    _/  _/            _/\n\0".as_ptr(), c);
    putstr_colored(b"  _/    _/    _/  _/        _/    _/    _/_/        _/\n\0".as_ptr(), c);
    putstr_colored(b" _/    _/    _/  _/        _/    _/        _/\n\0".as_ptr(), c);
    putstr_colored(b"_/      _/_/_/    _/_/_/    _/_/    _/_/_/        _/\n\n\n\0".as_ptr(), c);
}